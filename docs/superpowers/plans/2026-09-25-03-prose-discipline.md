...
```json
{
  ...
  "version": "1.3.0",
  "description": "An engineering prose standard for agent-written text: short active sentences, plain words, comments that explain why, and labelled review comments.",
  "author": {
